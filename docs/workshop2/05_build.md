...
1. To do that, when a source member is edited, press F1 and select `Project Explorer: Run Compile`, or do a right click in the edited source member and select the compilation option, or do a right click on the source member in the explorer view and select the compilation option.
...
To build a project, use `Project Explorer: Run Build` function
...
Press F1, choose function `Project Explorer: Run Compile` (simple compilation)
