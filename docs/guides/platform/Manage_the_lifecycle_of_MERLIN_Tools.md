...
- Install Merlin tools
 ...
 ![Create a project](../../images/guides/installMerlinToolCreateProject.png)
   ...
   * Choose a project where the Merlin tool is installed into.
      ...
      > Note: In version 2, the IBM i Developer tool can only be installed into a single project.   
 ...
 ![ Choose an update channel](../../images/guides/installMerlinToolSelectChannel.png)
   ...
   * Choose a update strategy, which has two options. One option is Automatic which means once new versions are released, the installed Merlin tool will be upgraded to latest version automatically. The other is Manual which means once new versions are released, the installed Merlin tool will not be upgraded to latest version automatically. The update must be manually approved before installation can begin.
 ![Choose A Update Strategy](../../images/guides/installMerlinToolSelectUpdateStrategy.png)
